...
import com.wego.seolstudybe.chat.dto.ChatRoomCreateRequest;
...
public class ChatRoomController {
    ...
    public ResponseEntity<List<ChatRoomResponse>> getMentorChatRooms(
    ...
    public ResponseEntity<List<ChatRoomResponse>> getMenteeChatRooms(
    ...
    @GetMapping("/check")
    public ResponseEntity<ChatRoomResponse> checkExistingChatRoom(
